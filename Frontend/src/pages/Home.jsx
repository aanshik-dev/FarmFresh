    ...
    >
      ...
      >
        ...
        >
          <motion.div
            variants={itemVariants}
            className={`inline-flex items-center gap-2 border rounded-full px-4 py-1.5 text-xs font-mono tracking-wider uppercase ${
              isDark
          ...
          >
            ...
            />
            Agri-Allied Digital Coordination Network
          </motion.div>

          <motion.h1
            variants={itemVariants}
            className={`text-4xl sm:text-5xl lg:text-[56px] font-extrabold tracking-tight leading-[1.15] ${isDark ? "text-slate-100" : "text-slate-800"}`}
          >
            Grow Together,{" "}
            <span className="text-transparent bg-clip-text bg-linear-to-r from-emerald-400 via-teal-400 to-amber-400">
              Harvest Smarter
            </span>
          </motion.h1>
          ...
          <motion.p
            variants={itemVariants}
            className={`text-base sm:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0 ${isDark ? "text-slate-300" : "text-slate-600"}`}
          >
            Connecting farmer groups with collectives for seamless crop
            management, pickup scheduling, and post-harvest coordination — all
            in one platform.
          </motion.p>
          ...
          <motion.div
            variants={itemVariants}
            className={`flex flex-wrap items-center justify-center lg:justify-start gap-5 text-sm ${isDark ? "text-slate-400" : "text-slate-500"}`}
          >
            {[
              {
                icon: "lucide:users",
                text: "20+ Farmer Groups",
        ...
        {/* Image carousel */}
        {/* <div className="flex-1 flex justify-center lg:justify-end z-10 max-w-sm lg:max-w-none w-full">
          <AnimatePresence mode="wait">
            <motion.div
              key={imgIdx}
              ...
              exit={{ opacity: 0, x: -30 }}
              transition={{ duration: 0.5, ease: "easeInOut" }}
              className="w-72 lg:w-96 pointer-events-none select-none"
              style={{
                maskImage:
                  "linear-gradient(to top, transparent 0%, black 15%, black 100%)",
                WebkitMaskImage:
