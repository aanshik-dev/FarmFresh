  ...
  return (
    <footer className="bg-slate-900 border-t border-slate-800 text-slate-400">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-12">
        <div className="flex flex-wrap justify-center gap-10">
          ...
          <div className="flex-1 min-w-[280px] max-w-lg flex flex-col md:items-baseline items-center">
            <Link to="/" className="inline-flex items-center gap-3 mb-5">
              ...
              <div>
                <h2 className="text-white font-bold tracking-widest text-lg text-nowrap quantico uppercase">
                  FarmFresh
                </h2>
                <p className="text-emerald-400 text-xs uppercase tracking-widest font-thin quantico">
                  Organic Collective
                </p>
              </div>
            </Link>
          ...
          <div className="flex-1 min-w-[280px]">
            <h3 className="text-slate-200 text-sm uppercase tracking-widest font-semibold mb-5 text-center md:text-left">
              Navigation
            </h3>
        ...
        <div className="flex flex-col md:flex-row justify-between text-center items-center gap-3 text-xs text-slate-500">
          <p>
